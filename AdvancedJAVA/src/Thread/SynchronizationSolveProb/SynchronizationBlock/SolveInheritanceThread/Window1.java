...
public class Window1 extends Thread{
    ...
    public void run() {
        ...
        while (true){
            ...
            synchronized (Window1.class){ //the reason it doesn't work here because it has to work with one obj, but in Window.java, we have three window instances, and every instance has one object.
                if(ticket > 0){
                    try {
                        Thread.sleep(10);
